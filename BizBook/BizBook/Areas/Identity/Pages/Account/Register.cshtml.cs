...
namespace BizBook.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if(!await _roleManager.RoleExistsAsync(StaticDetails.ConsumerEndUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(StaticDetails.ConsumerEndUser));
                    }
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, StaticDetails.ConsumerEndUser);
                    }
